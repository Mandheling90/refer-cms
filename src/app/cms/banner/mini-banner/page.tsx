...
function BannerFormDialog({
  ...
  const handleFileChange = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    reader.onload = (ev) => {
      ...
      img.onload = () => {
        if (img.width !== 600 || img.height !== 440) {
          alert(`이미지 사이즈가 맞지 않습니다.\n(600x440px 필요, 현재 ${img.width}x${img.height}px)`);
          return;
        }
        ...
        <DialogBody className="max-h-[70vh] overflow-y-auto p-0">
          ...
          <div className="px-6 py-5 space-y-2">
            ...
            <div className="space-y-0.5 text-xs text-muted-foreground">
              <p>이미지 사이즈: 가로 600px, 세로 440px / 파일 형식: png, jpg</p>
              <p>※ 해상도 600 x 440 고정입니다.</p>
  ...
  return (
    <div className="p-6 space-y-5">
      ...
      <div className="flex items-center gap-4">
        <h1 className="text-2xl font-bold text-foreground">미니배너</h1>
        <HospitalSelector />
      </div>
