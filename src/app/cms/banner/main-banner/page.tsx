    ...
    <>
      ...
      <div className="flex items-center justify-between px-3 py-2">
        <div className="flex items-center gap-1.5">
          ...
          <Badge className="gap-1 text-xs px-2 py-0.5 bg-muted text-foreground border-border" variant="outline">
            {isVideo ? (
              <>
      ...
      <div className="flex items-center px-3 py-2.5 min-h-[52px]">
        {dragHandleProps ? (
          ...
          <div
            className="p-0.5 text-muted-foreground/50 shrink-0"
  ...
  return (
    <div className="flex flex-col rounded-lg border border-border bg-card overflow-hidden">
      ...
      <div className="px-3 py-2.5 min-h-[52px] flex items-center">
        <span className="text-xs text-muted-foreground">새로운 배너를 등록합니다.</span>
      </div>
    </div>
  );
}
  ...
  return (
    <div className="p-6 space-y-5">
      ...
      <div className="flex items-center gap-4">
        <h1 className="text-2xl font-bold text-foreground">메인배너</h1>
        <HospitalSelector />
      </div>
      ...
      <div className="flex items-center justify-between border-b border-border pb-3">
        ...
        {isSelectMode && (
          <p className="text-sm text-muted-foreground">
            삭제할 배너를 선택 후 <strong className="text-foreground">선택 삭제</strong> 버튼을 눌러주세요.
          </p>
        )}
      </div>
